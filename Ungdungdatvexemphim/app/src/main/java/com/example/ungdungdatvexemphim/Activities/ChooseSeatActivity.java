...
public class ChooseSeatActivity extends Activity {
    ...
    String urlGetSeatBooked="http://10.20.78.183/PHP_Data/getSeatBooked.php";
    String getUrlGetSeatBooked2="http://10.20.78.183/php_ebooking/getSeatBooked2.php";
    String urlgetTicket="http://192.168.1.216/PHP_Data/getTicket.php";


    String urlGetTenPhim="http://10.20.78.183/PHP_Data/getTenPhim.php";

    String urlGetSeatR="http://10.20.78.183/PHP_Data/getSeat.php";
    String urlGetIDphim="http://10.20.78.183/PHP_Data/getMovieName.php";
